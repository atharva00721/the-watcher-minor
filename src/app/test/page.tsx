...
const Icons = {
  camera: memo(({ className, title }: IconProps) => (
    <svg
      viewBox="0 0 24 24"
      className={className}
      aria-hidden="true"
  ...
  stream: memo(({ className, title }: IconProps) => (
    <svg
      viewBox="0 0 24 24"
      className={className}
      aria-hidden="true"
  ...
  ai: memo(({ className, title }: IconProps) => (
    <svg
      viewBox="0 0 24 24"
      className={className}
      aria-hidden="true"
  ...
  analytics: memo(({ className, title }: IconProps) => (
    <svg
      viewBox="0 0 24 24"
      className={className}
      aria-hidden="true"
  ...
  alert: memo(({ className, title }: IconProps) => (
    <svg
      viewBox="0 0 24 24"
      className={className}
      aria-hidden="true"
